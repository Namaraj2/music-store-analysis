...
SELECT CONCAT(TRIM(last_name),' ', TRIM(first_name)) AS name, title
FROM employee
...
SELECT CONCAT(TRIM(c.first_name), ' ', TRIM(c.last_name)) AS name, sum(i.total) AS total 
FROM customer AS c
JOIN invoice AS i
